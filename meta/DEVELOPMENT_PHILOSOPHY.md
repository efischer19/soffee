...
This document outlines the core principles that guide all development within the `soffee` project. As a contributor (human or AI), you are expected to understand and adhere to these principles in all generated code, commits, and pull requests.
