...
This document outlines the ethical principles that govern all data gathering, scraping, and API interaction conducted by the `soffee` project. Our goal is to build useful software while acting as good citizens of the digital world. Adherence to these principles is mandatory for all code, whether generated by AI or written by humans. Our project's long-term viability depends on the trust and respect we show to the data sources we rely on.
...
* **Example `User-Agent`:** `soffee/0.1 (+https://github.com/efischer19/soffee)`
